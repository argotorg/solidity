...
Bugfixes:
* Standard JSON Interface: Fix the entire output being replaced by a `JSONError` ("Error writing output JSON.") when an error message quotes a source line that is not valid UTF-8.
