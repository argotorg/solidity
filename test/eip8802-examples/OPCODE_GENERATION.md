# EIP-8802 Code Generation - Opcode Mapping

This document explains how the Solidity compiler generates bytecode for EIP-8802 subscribe and unsubscribe statements.
...
```bash
./build/solc/solc --bin --abi --ir ../test/eip8802-examples/DerivedProtocol.sol > output.txt
```
...
The generated bytecode is ready to run on your EIP-8802 modified Geth!
