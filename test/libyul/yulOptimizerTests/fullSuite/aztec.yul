...
//         let notes_1 := add(0x04, _1)
//         let m := calldataload(0x24)
//         let n_1 := calldataload(notes_1)
...
//         hashCommitments(notes_1, n_1)
//         let b := add(0x300, shl(7, n_1))
//         let i_1 := 0
//         for { } lt(i_1, n_1) { i_1 := add(i_1, 0x01) }
//         {
//             let _2 := add(_1, mul(i_1, 0xc0))
//             let noteIndex := add(_2, 0x24)
//             let k_1 := 0
//             let a_1 := calldataload(add(_2, 0x44))
//             let c := challenge
//             let _3 := add(i_1, 0x01)
//             switch eq(_3, n_1)
//             case 1 {
...
//                 if eq(m, n_1)
//                 {
//                     k_1 := sub(0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001, kn)
//                 }
//             }
//             case 0 {
//                 k_1 := calldataload(noteIndex)
//             }
//             validateCommitment(noteIndex, k_1, a_1)
//             switch gt(_3, m)
//             case 1 {
...
//                 a_1 := mulmod(a_1, x, 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001)
...
//     {
//         let t2_x_1 := calldataload(0x64)
//         let t2_x_2 := calldataload(132)
//         let t2_y_1 := calldataload(164)
//         let t2_y_2 := calldataload(196)
