...
// ----
// TypeError 8476: (167-174): This `super` call would have to skip external function "X.f" to reach its target in the linearization of contract "D". External functions have no internal entry point and can never be reached through `super`. Declare "X.f" as `public` or reorder the inheritance hierarchy.
