...
struct EVMBuiltins
{
	...
	static auto constexpr CALLTOKEN = PatternGenerator<Instruction::CALLTOKEN>{};
	static auto constexpr TOKENBALANCE = PatternGenerator<Instruction::TOKENBALANCE>{};
	static auto constexpr CALLTOKENVALUE = PatternGenerator<Instruction::CALLTOKENVALUE>{};
	static auto constexpr CALLTOKENID = PatternGenerator<Instruction::CALLTOKENID>{};
	static auto constexpr ISCONTRACT = PatternGenerator<Instruction::ISCONTRACT>{};
	static auto constexpr NATIVEFREEZE = PatternGenerator<Instruction::NATIVEFREEZE>{};
	static auto constexpr NATIVEUNFREEZE = PatternGenerator<Instruction::NATIVEUNFREEZE>{};
	static auto constexpr NATIVEFREEZEEXPIRETIME = PatternGenerator<Instruction::NATIVEFREEZEEXPIRETIME>{};
	static auto constexpr NATIVEVOTE = PatternGenerator<Instruction::NATIVEVOTE>{};
	static auto constexpr NATIVEWITHDRAWREWARD = PatternGenerator<Instruction::NATIVEWITHDRAWREWARD>{};
	static auto constexpr NATIVEFREEZEBALANCEV2 = PatternGenerator<Instruction::NATIVEFREEZEBALANCEV2>{};
	static auto constexpr NATIVEUNFREEZEBALANCEV2 = PatternGenerator<Instruction::NATIVEUNFREEZEBALANCEV2>{};
	static auto constexpr NATIVECANCELALLUNFREEZEV2 = PatternGenerator<Instruction::NATIVECANCELALLUNFREEZEV2>{};
	static auto constexpr NATIVEWITHDRAWEXPIREUNFREEZE = PatternGenerator<Instruction::NATIVEWITHDRAWEXPIREUNFREEZE>{};
	static auto constexpr NATIVEDELEGATERESOURCE = PatternGenerator<Instruction::NATIVEDELEGATERESOURCE>{};
	static auto constexpr NATIVEUNDELEGATERESOURCE = PatternGenerator<Instruction::NATIVEUNDELEGATERESOURCE>{};
